...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] text-[#111] font-sans selection:bg-black selection:text-white overflow-x-hidden">
      {/* Navigation - Name size increased & Underline fix */}
      <nav className="p-8 flex justify-between items-center max-w-6xl mx-auto uppercase tracking-tighter font-bold">
        <span className="text-xl">Gauri Mishra</span> {/* Increased size by ~3pt */}
        <div className="space-x-8 flex items-center text-sm">
          <a href="https://github.com/gaurimishra3107" target="_blank" className="hover:underline decoration-2 underline-offset-4">GitHub</a>
          <a href="https://leetcode.com/u/mishra_gaurii/" target="_blank" className="text-orange-500 hover:underline decoration-2 underline-offset-4">LeetCode</a>
...
optimize inventory management.
      ...
      {/* Improved Stats Section with Codolio Image */}
      <section className="px-8 py-32 bg-[#0a0a0a] text-white overflow-hidden border-y border-gray-800">
      ...
      <footer className="p-8 text-center text-gray-400 text-[10px] uppercase tracking-[0.3em] mt-20">
        © 2026 Gauri Mishra — Crafted for Impact
      </footer>
    </div>
  );
};
